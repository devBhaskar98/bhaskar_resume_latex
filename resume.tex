...
% COMPANY - Mobile Programming
    ...
    {Xcelerator Admin Console  (\normalfont \textit{for Siemens DISW})}{Oct 2021 -- Present}
        ...
        \begin
            ...
            \item\small Implement agile methodologies for swift development and testing of bug fixes.
            \item\small Maintain code stability through rigorous testing and quality assurance measures.
        ...
        \begin{itemize}[leftmargin=-0.15in, label={}]
            \item\textit{\textbf{\fontsize{10}{12}\selectfont Java, Typescript, Node JS, Web Application, Microservices, Docker, Kibana, Gitlab, Coverity, Sonar, AWS, VS, VS Code, Postman, Git, Jest, Junit, AWS}}
        \end{itemize}
    ...
    \resumeItemListStart
        ...
        {Aug 2019 -- Oct 2021}
            ...
            \begin
                ...
                \item\small Implement UI and efficient Optmization, data structures, and caching mechanisms to streamline data retrieval and processing, reducing latency and improving user experience.
            \end{itemize}
